...
const DE = {
  ...
  Relief: 'Relief', Excavation: 'Aushub', 'Excavation for': 'Aushub für', 'Excavation for the house': 'Aushub für das Haus', depth: 'Tiefe',
...
async function boot() {
  ...
  /* `color` overrides the group's; `opacity` is the glass's — 0.05 for
     a wireframe's whisper of a face, more for a solid. */
