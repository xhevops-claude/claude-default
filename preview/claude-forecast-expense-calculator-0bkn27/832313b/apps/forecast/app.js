...
(function () {
  ...
  function renderInvestments() {
    ...
    $('invest-note').textContent = '"Put in" counts the cash listed above — ' +
      'deposits and parking. Instalments already paid before the forecast starts ' +
      'are not in it; add them as a cost line and they will be.';
  }
